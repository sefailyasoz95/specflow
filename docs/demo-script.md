...
| --- | --- | --- |
| 0:00–0:15 | Landing page, badge turns orange, tool list open | "SpecFlow is a project planner that exposes itself to agents over WebMCP. Six tools, live in the page." |
...
| 2:50–3:00 | Board, final state | "Agents propose. Humans dispose. That's SpecFlow." |
